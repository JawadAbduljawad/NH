...
VERSION=2024022001
BASE_URL=https://image-nethunter.kali.org/nethunter-fs/kali-2024.3/
USERNAME=kali
...
function set_strings() {
    ...
    IMAGE_NAME=kali-nethunter-2024.3-rootfs-full-amd64.tar.xz
    SHA_NAME=kali-nethunter-2024.3-rootfs-full-amd64.sha512sum
}    
